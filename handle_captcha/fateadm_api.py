...
from .settings import PD_ID,PD_KEY, APP_ID, APP_KEY
...
def Captcha(operating=1, img_data=None,  path=None, rsp=None, pred_type="30400"):
    ...
    返回值: rsp
        ...
        rsp.cust_val        ：用户余额
     """
    # 阳光 304000005 都邦304000002 天平304000003 太平洋304000004
    # 识别类型，
